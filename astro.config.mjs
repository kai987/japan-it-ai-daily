...
const verifiedInlineScripts = [
  ...
  "'sha256-kr+CsDwD9BRdN2U0/hd4egGkPWdwpMfpsuniI6IEuRs='", // default locale redirect (zh-rendered page)
  "'sha256-roooHlTUkWkiyqXOcqIddVcJllGrKU6XVZtzsqk513I='", // default locale redirect (ja-rendered page)
  ...
  "'sha256-bQBCnhdTnm9gfu3c4DhoRG+s+a5f7j+mjI68EWA53j4='", // unified report speech enhancer
];
